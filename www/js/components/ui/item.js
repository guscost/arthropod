define(["require", "exports", "react/jsx-runtime", "@base-ui/react/merge-props", "@base-ui/react/use-render", "class-variance-authority", "@/lib/utils", "@/components/ui/separator"], function (require, exports, jsx_runtime_1, merge_props_1, use_render_1, class_variance_authority_1, utils_1, separator_1) {
    ...
    const itemVariants = (0, class_variance_authority_1.cva)("group/item flex w-full flex-wrap items-center rounded-md border text-sm transition-colors duration-100 outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 [a]:transition-colors [a]:hover:bg-muted", {
        variants: {
            variant: {
