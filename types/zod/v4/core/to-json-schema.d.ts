...
export declare function initializeContext(
  params: JSONSchemaGeneratorParams,
): ToJSONSchemaContext;
export declare function process<T extends schemas.$ZodType>(
  schema: T,
  ctx: ToJSONSchemaContext,
  _params?: ProcessParams,
): JSONSchema.BaseSchema;
export declare function extractDefs<T extends schemas.$ZodType>(
  ctx: ToJSONSchemaContext,
  schema: T,
): void;
export declare function finalize<T extends schemas.$ZodType>(
  ctx: ToJSONSchemaContext,
  schema: T,
 ...
 */
export declare const createToJSONSchemaMethod: <T extends schemas.$ZodType>(
  schema: T,
  processors?: Record<string, Processor>,
...
>[0];
export declare const createStandardJSONSchemaMethod: <
