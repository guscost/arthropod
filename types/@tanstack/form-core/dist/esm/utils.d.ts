import { FieldValidators } from "./FieldApi";
 ...
 * @private
 */
export declare function makePathArray(
 ...
 * @private
 */
export declare function getSyncValidatorArray<T>(
  cause: ValidationCause,
 ...
 * @private
 */
export declare function getAsyncValidatorArray<T>(
  cause: ValidationCause,
...
>
  ...
  : T extends FormValidators<any, any, any, any, any, any, any, any, any, any>
    ? Array<
      ...
      >
    : never;
export declare const isGlobalFormValidationError: (
  error: unknown,
 ...
 * @private
 */
export declare const determineFormLevelErrorSourceAndValue: ({
 ...
 * @private
 */
export declare const determineFieldLevelErrorSourceAndValue: ({
  formLevelError,
  fieldLevelError,
}: {
 ...
 * @private
 */
export declare function mergeOpts<T>(
