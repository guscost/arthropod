...
declare function createCollection$1<
...
>(
...
): readonly [
  {
    ...
    readonly Slot: React.ForwardRefExoticComponent<
      CollectionProps$1 & React.RefAttributes<HTMLElement>
    >;
...
>(
  ...
  },
  {
    ...
    useInitCollection: () => [
      ItemMap<ItemElement, ItemData>,
      React.Dispatch<React.SetStateAction<ItemMap<ItemElement, ItemData>>>,
    ];
  },
];

export {
  type CollectionProps$1 as CollectionProps,
  createCollection$1 as createCollection,
  type CollectionProps$1 as unstable_CollectionProps,
